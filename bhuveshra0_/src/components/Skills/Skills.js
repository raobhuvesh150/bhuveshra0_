...
function Skills() {
  return (
    <div className="bg-homeTheme">
      <div className="d-flex justify-content-center m-auto flex-column flex-md-row align-items-center">
        <img
          style={{ width: "100px", padding: "50px" }}
          className="d-sm-block d-md-inline-block m-auto"
          src={Reactimg}
        ></img>
        <img
          style={{ width: "100px", padding: "50px" }}
