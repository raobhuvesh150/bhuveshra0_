            ...
            <div id={styles.designContainer} className=' position-relative m-auto bg-homeTheme d-block h-75 '>
                ...
                <div className='m-3'>
                    ...
                    <div className='shadow-lg pb-5'>
                        ...
                        <p className='justify-content-start p-1 d-flex w-100 fs-6  mt-5'>Name &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; - &nbsp; &nbsp; &nbsp; Bhuvesh</p>
                        <p className='justify-content-start p-1 d-flex w-100 fs-6  mt-2 '>Email &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; - &nbsp; &nbsp; &nbsp; raobhuvesh150@gmail.com</p>
                        <p className='justify-content-start p-1 d-flex w-100 fs-6 mt-2'> Address   &nbsp; &nbsp; - &nbsp; &nbsp; &nbsp; Gurugaon</p>
                        <p className='justify-content-start p-1 d-flex w-100 fs-6 mt-2'>Phone &nbsp; &nbsp; &nbsp; &nbsp; - &nbsp; &nbsp; &nbsp; 9588741195</p>
                    </div>
